...
print(model_name)
train_batch_size =8          #128 The larger you select this, the better the results (usually). But it requires more GPU memory
max_seq_length = 100
num_epochs = 3
...
nli_dataset_path = r'data\bertTrain111-su.tsv.gz'
sts_dataset_path = r'data/bertTest111-su.tsv.gz'
